...
from utils.insightface.deploy import face_model
import warnings
import sys
import dlib
...
class FacePredictor():
    def __init__(self):
        try:
            ...
            self.model = "./utils/insightface/models/model-y1-test2/model,0"
            self.threshold = 1.24
            self.det = 0
            ...
            self.embeddings = "./utils/faceEmbeddingModels/embeddings.pickle"
            self.le = "./utils/faceEmbeddingModels/le.pickle"
            ...
            self.model = load_model('./utils/faceEmbeddingModels/my_model.h5')
